...
(function () {
        ...
        if (this.chart.config.type === "polarArea") {
            ...
            if (this.barTotal[index] === undefined) {
                ...
                for (var i = 0; i < this.chart.data.datasets.length; ++i) {
                    this.barTotal[index] += this.chart.data.datasets[i].data[
                        index
                    ];
                }
            }
    ...
    if (typeof Chart.register === "function") Chart.register(LabelPlugin);
    else Chart.plugins.register(LabelPlugin);
})();
